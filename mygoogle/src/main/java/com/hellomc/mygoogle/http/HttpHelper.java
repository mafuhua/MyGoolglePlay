package com.hellomc.mygoogle.http;
...
public class HttpHelper {
    ...
    /**
     * @param imageName:app/com.youyuan.yyhl/icon.jpg
     * @return
     */
    public static String getImageUrl(String imageName) {
        return URL + "image?name=" + imageName;//http://127.0.0.1:8090/image?name=app/com.youyuan.yyhl/icon.jpg
    }
